...
class StockPicking(models.Model):
    ...
    def _onchange_picking_type_id(self):
        if self.partner_id: 
            ...
            #         self.l10n_pe_edi_picking_driver_doc_type = partner.l10n_latam_identification_type_id.id
            #         self.l10n_pe_edi_picking_driver_doc_number = partner.vat
            #         self.l10n_pe_edi_picking_driver_name = partner.name
            #         self.l10n_pe_edi_picking_carrier_doc_type = ""
            ...
            #     else:
            #         self.l10n_pe_edi_picking_carrier_doc_type = partner.l10n_latam_identification_type_id.id
            ...
            #         self.l10n_pe_edi_picking_driver_doc_type = ""
            #         self.l10n_pe_edi_picking_driver_doc_number = ""
            #         self.l10n_pe_edi_picking_driver_name = ""
